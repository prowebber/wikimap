...
var _accessorFn = require('accessor-fn');

var _accessorFn2 = _interopRequireDefault(_accessorFn);

var _d3ScaleChromatic = require('d3-scale-chromatic');

var _d3Force3d = require('d3-force-3d');
...
var _ngraph3 = require('ngraph.forcelayout');

var _ngraph4 = _interopRequireDefault(_ngraph3);

var _ngraph5 = require('ngraph.forcelayout3d');

var _ngraph6 = _interopRequireDefault(_ngraph5);

var _kapsule = require('kapsule');

var _kapsule2 = _interopRequireDefault(_kapsule);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var ngraph = { graph: _ngraph2.default, forcelayout: _ngraph4.default, forcelayout3d: _ngraph6.default };

//

var CAMERA_DISTANCE2NODES_FACTOR = 150;

exports.default = (0, _kapsule2.default)({
    ...
    init: function init(domNode, state) {
        ...
        var tbControls = new _threeTrackballcontrols2.default(state.camera, state.renderer.domElement);
    ...
    update: function updateFn(state) {
        ...
        if (!state.fetchingJson && state.jsonUrl && !state.graphData.nodes.length && !state.graphData.links.length) {
            ...
            _qwest2.default.get(state.jsonUrl).then(function (_, json) {
        ...
        var visitedAccessor = (0, _accessorFn2.default)(state.visitedField);
        var nameAccessor = (0, _accessorFn2.default)(state.nameField);
        var valAccessor = (0, _accessorFn2.default)(state.valField);
        var colorAccessor = (0, _accessorFn2.default)(state.colorField);
        ...
        state.graphData.nodes.forEach(function (node) {
            ...
            var color = colorAccessor(node) || baseColor;
        ...
        function autoColorNodes(nodes, colorBy, colorField) {
            ...
            var colorByAccessor = (0, _accessorFn2.default)(colorBy);

            var colors = _d3ScaleChromatic.schemePaired; // Paired color set from color brewer
