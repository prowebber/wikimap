...
import v from './globals.js';				// Custom globals
...
export default Kapsule({
	...
	init: function(domNode, state) {
		...
		state.scene.fog = new three.FogExp2(state.backgroundColor,0.0020);
		...
		v.wiki_ani = (function animate() { // IIFE
