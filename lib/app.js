...
export default Kapsule({
	...
	props: {
		...
		linkWidth: { default: 10, triggerUpdate: false },
	...
	init: function(domNode, state) {
		...
		state.forceGraph.onFinishLoading(() => {
			...
			// 	state.linkWidth(link) = 10
			// 	console.log(Object.entries(link));
			// // 	state.useCylinder = true;
			// // 	state.linkWidth = 10;
			// // 	v.list_props(link);
			// // 	lkjhlkjkljlk();
			// });
		...
		state.scene.fog = new three.FogExp2(state.backgroundColor,0.003);
