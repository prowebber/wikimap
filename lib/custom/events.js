...
function showGraph(jsonResponse) {
	...
	v.elem.appendChild(renderer.domElement);
	v.elem.appendChild(v.nav_info = document.createElement('div'));
	v.nav_info.className = 'graph-nav-info';
	v.nav_info.textContent = "Left-click: Rotate, Right-click: Pan, Scroll: Zoom";
	v.elem.appendChild(v.info_elem = document.createElement('div'));
	...
	v.elem.appendChild(v.toolTipElem);
...
function config(){
// Wait until the page is loaded before starting
