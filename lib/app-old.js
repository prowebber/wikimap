...
// const bindTB = linkKapsule('tb', ThreeTrackballControls);
// const linkedTBProps = Object.assign(...[
// 	'object',
// 	'domElement',
// 	'enabled',
// 	'screen',
...
// 	'position0',
// 	'up0'
// ].map(p => ({ [p]: bindTB.linkProp(p)})));
// const linkedTBMethods = Object.assign(...[
// 	'mousedown'
// ].map(p => ({ [p]: bindTB.linkMethod(p)})));
